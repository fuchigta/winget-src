...
func TestDispatchProvider(t *testing.T) {
	...
	for _, tt := range tests {
		_, err := dispatchProvider(PackageListEntry{Provider: tt.provider}, http.DefaultClient, nil)
...
func TestDispatchProvider_ErrorContainsProviderName(t *testing.T) {
	_, err := dispatchProvider(PackageListEntry{Provider: "myunknownprovider"}, http.DefaultClient, nil)
	if err == nil {
